...
memory = SqliteSaver(sqlite3.connect("agentic_rag_pro.db", check_same_thread=False))
graph = builder.compile(checkpointer=memory)

# --- 6. RUN ---
config = {"configurable": {"thread_id": "pro_rag_1"}}
task = {"messages": [HumanMessage(content="Compare the energy density of the QV-1 with the latest 2026 solid-state battery news.")]}
